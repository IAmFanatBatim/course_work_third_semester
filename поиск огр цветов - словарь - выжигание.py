...
while gen_i < len(pixel_counting.keys()):
    ...
    cur_color_array = getColorArray(cur_code)
    #print(i, pixel_counting[gen_i], cur_color_array)
    if (pixel_counting[cur_code] > key_colors_frequency[19]):
        for l in range (0, key_colors_amount):
            if pixel_counting[cur_code] > key_colors_frequency[l]:
                key_colors_frequency[l+1:key_colors_amount] = key_colors_frequency[l:key_colors_amount-1]
                key_colors_frequency[l] = pixel_counting[cur_code]
